...
namespace Bednarz.Jorge._2C.TP3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                Alumno a2 = new Alumno(2, "Juana", "Martinez", "1M2234458", EntidadesAbstractas.Persona.ENacionalidad.Extranjero, Gimnasio.EClases.Natacion, Alumno.EEstadoCuenta.Deudor);
                gim += a2;
            }
